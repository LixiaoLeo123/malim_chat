...
function DictionaryPopover({ word, anchor, onClose }: { word: string; anchor: { x: number; y: number }; onClose: () => void }) {
  const dictionaries = ["russian_en", "german_en", "english_zh"] as const; type Dictionary = typeof dictionaries[number];
