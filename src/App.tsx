...
import { Archive, Bot, Check, ChevronDown, ChevronsUpDown, CircleAlert, Copy, Edit3, Globe2, Languages, LoaderCircle, LogOut, Menu, MessageSquare, MoreHorizontal, PanelLeftClose, PanelLeftOpen, Search, Settings2, SquarePen, Trash2, X } from "lucide-react";
...
function ConversationView({ conversation, messages, providers, searchEnabled, busy, onSend, onEdit, onDelete, onRetry, onLookup, onCompact }: { conversation: Conversation | null; messages: Message[]; providers: Provider[]; searchEnabled: boolean; busy: boolean; onSend: (content: string) => Promise<void>; onEdit: (message: Message, content: string) => Promise<void>; onDelete: (message: Message) => Promise<void>; onRetry: (message: Message) => Promise<void>; onLookup: (word: string) => void; onCompact: () => Promise<void> }) {
