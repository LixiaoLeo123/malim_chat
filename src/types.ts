...
export interface GenerationSettings { temperature: number; reasoning_effort: "low" | "medium" | "high"; enable_markdown: boolean; stream: boolean; builtin_tools?: boolean; context_rounds?: number | null; tool_rounds?: number | null }
