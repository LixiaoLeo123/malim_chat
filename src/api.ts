...
export const api = {
  ...
  respond: (conversationId: string, messageId: string, search: boolean, options?: { temperature?: number; reasoning_effort?: string; enable_markdown?: boolean; context_rounds?: number | null; tool_rounds?: number | null; builtin_tools?: boolean; stream?: boolean }) => request<Message>(`/v1/conversations/${conversationId}/respond`, { method: "POST", body: JSON.stringify({ message_id: messageId, search, ...options }) }),
  respondStream: (conversationId: string, messageId: string, search: boolean, options: { temperature?: number; reasoning_effort?: string; enable_markdown?: boolean; context_rounds?: number | null; tool_rounds?: number | null; builtin_tools?: boolean }, onEvent: (event: StreamEvent) => void, signal?: AbortSignal) => requestStream(`/v1/conversations/${conversationId}/respond`, { message_id: messageId, search, ...options, stream: true }, onEvent, signal),
